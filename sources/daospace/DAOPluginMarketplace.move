module DAOSpaceFramework::DAOPluginMarketplace {
    ...
    use DAOSpaceFramework::DAORegistry;
    ...
    public fun initialize() {
        ...
        let signer = DAORegistry::get_daospace_signer();
    ...
    public fun register_plugin<PluginT: store>(_witness: &PluginT, name: vector<u8>, description: vector<u8>, option_labels: Option<vector<vector<u8>>>): u64 
        ...
        let daospace_account = DAORegistry::get_daospace_signer();
        ...
        move_to(&daospace_account, PluginEntry<PluginT>{
            id: copy plugin_id, 
            name: copy name, 
        ...
        move_to(&daospace_account, PluginEventHandlers<PluginT>{
            publish_version: Event::new_event_handle<PluginPublishVersionEvent<PluginT>>(&daospace_account),
            star: Event::new_event_handle<StarPluginEvent<PluginT>>(&daospace_account),
            unstar: Event::new_event_handle<UnstarPluginEvent<PluginT>>(&daospace_account),
            update_plugin: Event::new_event_handle<UpdatePluginInfoEvent<PluginT>>(&daospace_account),
        });
