module DAOSpaceFramework::DAOSpace {
    ...
    use DAOSpaceFramework::DAOAccount::{Self, DAOAccountCap};
    use DAOSpaceFramework::DAORegistry;
    use DAOSpaceFramework::SBTVoteStrategy;
    use DAOSpaceFramework::SnapshotUtil;
    use DAOSpaceFramework::DAOPluginMarketplace;

    // friend DAOSpaceFramework::StarcoinDAO;
    ...
    struct DAOSBTBurnCapHolder<phantom DAOT> has key {
        cap: Token::BurnCapability<DAOT>,
    }

    /// Capability for minting any tokens.
    struct DAOTokenMintCapHolder<phantom DAOT, phantom TokenT> has key {
        cap: Token::MintCapability<TokenT>,
    }

    /// Capability for burning any tokens.
    struct DAOTokenBurnCapHolder<phantom DAOT, phantom TokenT> has key {
    ...
    struct DAOGrantCap<phantom DAOT> has drop {}
